...
All of the k0sproject repositories follow the usual [Github flow](https://docs.github.com/get-started/quickstart/github-flow).

Rest of this document will use `k0s` repository as the example, but the guide really suits all of the repos if not otherwise specified in the specific repository.
